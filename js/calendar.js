function lfCalendar(conf){
    var calendar={
        ...
        "renderCalendarBox":function(){
            ...
            row=row.find("._wx_A");
            row.append("<a class='_wx_A_1' href='javascript:void(0)'><i class='fa fa-angle-left'></i></a>");
            row.append("<a class='_wx_A_2' href='javascript:void(0)'><i class='fa fa-angle-right'></i></a>");
            row.append("<a class='_wx_A_3 selectyear-month' href='javascript:void(0)'>" +
                "<span class='year'>"+this.data.year+"</span>年" +"<span class='month'>"+this.data.month+"</span>月" +
                "</a>");
            row.append("<a class='_wx_A_4 selectyear-month-i' href='javascript:void(0)'><i class='fa fa-angle-down'></i></a>");
        ...
        "setDate": function () {
            var a;
            if (conf.date == undefined || conf.date == null) {
                a = new Date();
            } else {
                a = conf.date;
            }
